...
**Read this file at the start of every Codex session.** It is the difference between a project that stays clean across many phases and one that becomes unmaintainable.
...
- **Type everything.** All function signatures and class attributes. Not for mypy strictness — for the next Codex who reads this.
...
## Codex working tips (what actually helps in practice)
